...
A timing side-channel occurs when the execution time of a program is influenced by secret data.
...
% \textcolor{orange}{TODO: It would be good to finish with a question.}
